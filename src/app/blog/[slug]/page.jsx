...
async function getBlogData(slug) {
  ...
  try {
    ...
    const res = await fetch(
      `https://faridabad-backend.onrender.com/blogs/getBlogBySlug/${slug}?domain=www.realestateagentsinfaridabad.com`,
      {
         cache: "force-cache",
...
export default async function Page({ params }) {
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#FFF8F9] to-[#F3E3E8]">
  ...
  return (
    <div className="bg-gradient-to-br from-[#FFF8F9] to-[#F3E3E8]"> 
